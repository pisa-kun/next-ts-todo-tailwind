...
export default function Auth() {
    ...
    <div>
      ...
      <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-white-900">Sign in to your account</h2>
    ...
    <form className="mt-8 space-y-6" action="#" method="POST">
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="text-sm">
          <span className="cursor-pointer font-medium text-white-600 hover:text-indigo-500">Change mode ?</span>
        </div>
      </div>
